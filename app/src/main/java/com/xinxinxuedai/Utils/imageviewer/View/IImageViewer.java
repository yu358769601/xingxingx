...
public interface IImageViewer {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(ImageViewerAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnImageTapListener(ImageViewerAttacher.OnImageTapListener listener);
     ...
     */
    ImageViewerAttacher.OnImageTapListener getOnImageTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(ImageViewerAttacher.OnViewTapListener listener);
     ...
     */
    ImageViewerAttacher.OnViewTapListener getOnViewTapListener();
