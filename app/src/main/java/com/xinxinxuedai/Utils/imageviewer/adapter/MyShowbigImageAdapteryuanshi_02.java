package com.xinxinxuedai.Utils.imageviewer.adapter;
...
import com.xinxinxuedai.Utils.imageviewer.View.ImageViewerr;
...
public class MyShowbigImageAdapteryuanshi_02 extends PagerAdapter {
    ...
    private void initSimpleDraweeView() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            View inflate = mInflater.inflate(0, null);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
       ...
       tutu = (ImageViewerr) view.findViewById(0);
