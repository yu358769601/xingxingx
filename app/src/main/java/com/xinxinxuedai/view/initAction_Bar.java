...
//    }
    ...
    private initAction_Bar initView(Context context) {
        ...
        mAction_bar_tv_back = (Button) mBase_action_bar.findViewById(R.id.relativeLayout_title_leftbutton);
        mRelativeLayout_title_rightbutton = (Button) mBase_action_bar.findViewById(R.id.relativeLayout_title_rightbutton);
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.relativeLayout_title_leftbutton ) {
